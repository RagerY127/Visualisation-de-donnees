...
import NetworkD3 from './Network-d3';
...
function NetworkContainer(){
    ...
    useEffect(()=>{
        console.log("NetworkContainer useEffect (called each time network re-renders)");
    ...
    useEffect(()=>{
        console.log("NetworkContainer useEffect [] called once the component did mount");
        const visD3 = new NetworkD3(divContainerRef.current);
        visD3.create({size:getCharSize()});
        visD3Ref.current = visD3;
        return ()=>{
            // did unmout, the return function is called once the component did unmount (removed for the screen)
            console.log("NetworkContainer useEffect [] return function, called when the component did unmount...");
    ...
    useEffect(()=>{
        console.log("NetworkContainer useEffect with dependency [visData,dispatch], called each time visData changes...");
        const visD3 = visD3Ref.current;
